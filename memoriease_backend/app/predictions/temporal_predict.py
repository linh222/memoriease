...
from app.predictions.utils import process_query, build_query_template_temporal, construct_filter, calculate_overall_score
...
def time_processing_event(list_event_query, main_event, time_gap, time_period, location, keyword, weekday, embed,
    ...
    previous_filter_template = build_query_template_temporal(previous_filter, embed, size=1)
...
def temporal_search(concept_query, embed_model, txt_processor, clip_model, clip_tokenizer,
    ...
    main_event_result = retrieve_image(concept_query=concept_query, embed_model=embed_model, txt_processor=txt_processor,
                                       clip_model=clip_model, clip_tokenizer=clip_tokenizer, semantic_name=semantic_name)
